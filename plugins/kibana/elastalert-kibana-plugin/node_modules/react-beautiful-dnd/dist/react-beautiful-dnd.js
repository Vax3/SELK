(function (global, factory) {
	...
	(global = global || self, factory(global.ReactBeautifulDnd = {}, global.React));
	...
	*/
	...
	var parse = function parse(raw) {
	  ...
	  !(suffix === 'px') ? invariant$1(false, "Expected value to be a pixel value.\n      Expected form: 10px\n      Actual value: " + raw + "\n    ") : void 0;
	...
	var createStore$1 = (function (_ref) {
	  ...
	  return createStore(reducer, composeEnhancers(applyMiddleware(style(styleMarshal), dimensionMarshalStopper(getDimensionMarshal), lift$1(getDimensionMarshal), drop$1, dropAnimationFinish, pendingDrop, autoScroll(getScroller), responders(getResponders, announce))));
	});
	...
	var createStyleMarshal = (function () {
	  ...
	  var mount = function mount() {
	    ...
	    always.setAttribute(prefix$2 + "-always", context);
	    dynamic.setAttribute(prefix$2 + "-dynamic", context);
	...
	var styleKey = prefix$3('style');
	var canLiftKey = prefix$3('can-lift');
	var isMovementAllowedKey = prefix$3('is-movement-allowed');
	...
	*/
	...
	var Droppable = function (_React$Component) {
	  ...
	  _proto.getPlaceholder = function getPlaceholder() {
	    ...
	    return React__default.createElement(AnimateInOut, {
	...
	var DraggableDimensionPublisher = function (_Component) {
	  ...
	  function DraggableDimensionPublisher() {
	    ...
	    _this.publishedDescriptor = null;
	    _this.getMemoizedDescriptor = index(function (id, index, droppableId, type) {
	      return {
	        id: id,
	        index: index,
	        droppableId: droppableId,
	...
	var Draggable = function (_React$Component) {
	  ...
	  function Draggable(props, context) {
	    ...
	    _this.getProvided = index(function (mapped, dragHandleProps) {
