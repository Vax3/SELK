...
.euiButton--primary {
  ...
  .euiButton--primary.euiButton--fill {
    ...
    .euiButton--primary.euiButton--fill:disabled .euiButton__spinner {
      border-color: #1BA9F5 rgba(0, 0, 0, 0.7) rgba(0, 0, 0, 0.7) rgba(0, 0, 0, 0.7); }
...
.euiButtonEmpty--disabled {
  color: #b0b0b1; }
  .euiButtonEmpty--disabled:focus {
    background-color: rgba(45, 46, 48, 0.1); }
...
.euiButtonIcon--disabled {
  ...
  .euiButtonIcon--disabled:focus {
    background-color: rgba(67, 69, 72, 0.1); }
  .euiButtonIcon--disabled:hover, .euiButtonIcon--disabled:focus {
    cursor: not-allowed; }
  ...
  @supports (pointer-events: none) {
    .euiFlyoutBody {
      ...
      .euiFlyoutBody::after {
        ...
        top: 0;
        bottom: 0;
        background: linear-gradient(to bottom, rgba(29, 30, 36, 0.9) 0%, rgba(29, 30, 36, 0) 6px, rgba(29, 30, 36, 0) calc(100% - 6px), rgba(29, 30, 36, 0.9) 100%);
        pointer-events: none; } }
...
.euiRangeTooltip__value {
  ...
  .euiRangeTooltip__value::before {
    background-color: rgba(212, 218, 229, 0.2); }
...
.euiLink.euiLink--subdued {
  ...
  .euiLink.euiLink--subdued:focus {
    outline: solid 3px rgba(152, 162, 179, 0.1);
    background-color: rgba(152, 162, 179, 0.1); }
...
.euiLink.euiLink--danger {
  ...
  .euiLink.euiLink--danger:focus {
    outline: solid 3px rgba(255, 102, 102, 0.1);
    background-color: rgba(255, 102, 102, 0.1); }
...
.euiStepHorizontal-isSelected .euiStepHorizontal__number:not([class*='danger']):not([class*='warning']) {
  -webkit-box-shadow: 0 2px 2px -1px rgba(51, 162, 221, 0.3);
...
.euiToken--tokenTint01 {
  -webkit-box-shadow: 0 0 0 1px #1BA9F5;
          box-shadow: 0 0 0 1px #1BA9F5;
  background-color: #08334a; }
...
.euiToken--tokenTint02 {
  -webkit-box-shadow: 0 0 0 1px #F990C0;
          box-shadow: 0 0 0 1px #F990C0;
