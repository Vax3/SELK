  ...
  @supports (pointer-events: none) {
    .euiFlyoutBody {
      ...
      .euiFlyoutBody::after {
        ...
        top: 0;
        bottom: 0;
        background: linear-gradient(to bottom, rgba(255, 255, 255, 0.9) 0%, rgba(255, 255, 255, 0) 6px, rgba(255, 255, 255, 0) calc(100% - 6px), rgba(255, 255, 255, 0.9) 100%);
        pointer-events: none; } }
...
.euiLink.euiLink--text {
  ...
  .euiLink.euiLink--text:focus {
    outline: solid 3px rgba(45, 45, 45, 0.1);
    background-color: rgba(45, 45, 45, 0.1); }
