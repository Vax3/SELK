...
function (_AbstractSeries) {
  ...
  function EuiHistogramSeries() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(EuiHistogramSeries)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(EuiHistogramSeries, [{
    ...
    value: function render() {
      ...
      var HistogramSeriesComponent = _orientation === ORIENTATION.HORIZONTAL ? HorizontalRectSeries : VerticalRectSeries;
      return React.createElement(HistogramSeriesComponent, _extends({
        name: name,
        className: classes,
    ...
    value: function getParentConfig(attr, props) {
      ...
      return _orientation === ORIENTATION.HORIZONTAL ? HorizontalRectSeries.getParentConfig(attr) : VerticalRectSeries.getParentConfig(attr);
    }
  }]);
