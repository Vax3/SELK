    ...
    value: function render() {
      ...
      if (this.state.hasError) {
        ...
        return React.createElement("div", _extends({
          ...
          size: "xs"
        }, React.createElement("h1", null, "Error"), React.createElement("pre", {
          className: "euiErrorBoundary__stack"
        }, React.createElement("p", null, this.state.error && this.state.error.stack)))));
      }
