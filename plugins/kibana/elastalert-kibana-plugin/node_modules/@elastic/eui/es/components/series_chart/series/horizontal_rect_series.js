...
export var EuiHorizontalRectSeries =
/*#__PURE__*/
function (_HorizontalRectSeries) {
  ...
  _createClass(EuiHorizontalRectSeries, [{
    ...
    value: function render() {
      ...
      var classes = classNames('euiHistogramSeries', isHighDataVolume && 'euiHistogramSeries--highDataVolume', isMouseOverValue && onValueClick && 'euiHistogramSeries--hoverEnabled');
      return React.createElement(HorizontalRectSeries, _extends({
        key: name,
        className: classes,
