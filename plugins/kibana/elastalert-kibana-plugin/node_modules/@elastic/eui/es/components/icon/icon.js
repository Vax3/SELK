...
import { keysOf } from '../common'; // @ts-ignore-next-line
...
export var IconPropType = PropTypes.oneOfType([PropTypes.string, PropTypes.node]);
var colorToClassMap = {
  default: null,
...
function (_Component) {
  ...
  function EuiIcon(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "loadIconComponent", function (iconType) {
      import('./assets/' + typeToPathMap[iconType] + '.js').then(function (_ref) {
        var icon = _ref.icon;
  ...
  _createClass(EuiIcon, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["type", "size", "color", "className", "tabIndex"]);
