...
describe('Pager', function () {
  ...
  describe('methods', function () {
    ...
    var pager = new _pager.Pager(totalItems, itemsPerPage, initialPageIndex);
    beforeEach(function () {
      pager = new _pager.Pager(totalItems, itemsPerPage, initialPageIndex);
    });
