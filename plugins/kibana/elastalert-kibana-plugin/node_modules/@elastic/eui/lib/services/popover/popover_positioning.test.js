...
describe('popover_positioning', function () {
  describe('getElementBoundingBox', function () {
    ...
    it('returns a new JavaScript object with correct values', function () {
      ...
      var boundingBox = (0, _popover_positioning.getElementBoundingBox)(div);
  ...
  describe('getAvailableSpace', function () {
    ...
    it('returns the distance from each side of the anchor to each side of the container', function () {
      _popover_positioning.POSITIONS.forEach(function (side) {
        expect((0, _popover_positioning.getAvailableSpace)(anchorBoundingBox, containerBoundingBox, 0, 0, side)).toEqual(expectedAvailableSpace);
      });
    });
    it('subtracts the buffer amount from the returned distances', function () {
      _popover_positioning.POSITIONS.forEach(function (side) {
        expect((0, _popover_positioning.getAvailableSpace)(anchorBoundingBox, containerBoundingBox, 5, 0, side)).toEqual({
    ...
    it('subtracts the offset from the specified offsetSide', function () {
      _popover_positioning.POSITIONS.forEach(function (side) {
        expect((0, _popover_positioning.getAvailableSpace)(anchorBoundingBox, containerBoundingBox, 0, 5, side)).toEqual(_objectSpread({}, expectedAvailableSpace, _defineProperty({}, side, expectedAvailableSpace[side] - 5)));
      });
    });
    it('subtracts the buffer and the offset from the specified offsetSide', function () {
      _popover_positioning.POSITIONS.forEach(function (side) {
        expect((0, _popover_positioning.getAvailableSpace)(anchorBoundingBox, containerBoundingBox, 3, 1, side)).toEqual(_defineProperty({
          // apply buffer space
  ...
  describe('getVisibleFit', function () {
    it('calculates full visibility when content is fully enclosed by container', function () {
      ...
      expect((0, _popover_positioning.getVisibleFit)(content, container)).toBe(1);
    });
    ...
    it('calculates partial visibility when content overflows out of container', function () {
      ...
      expect((0, _popover_positioning.getVisibleFit)(content, container)).toBe(0.25);
    });
    it('calculates zero visibility when content is not in the container', function () {
      ...
      expect((0, _popover_positioning.getVisibleFit)(content, container)).toBe(0);
    });
  });
  describe('getPopoverScreenCoordinates', function () {
    describe('not enough space', function () {
      it('returns correct fit when the window does not have space on the primary axis', function () {
        ...
        expect((0, _popover_positioning.getPopoverScreenCoordinates)({
          position: 'top',
  ...
  describe('findPopoverPosition', function () {
    ...
    describe('placement in desired position', function () {
      it('finds space in the requested position', function () {
        ...
        expect((0, _popover_positioning.findPopoverPosition)({
          position: 'top',
          anchor: anchor,
          popover: popover,
          container: container,
