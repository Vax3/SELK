...
exports.EuiVerticalBarSeries = void 0;
...
var EuiVerticalBarSeries =
/*#__PURE__*/
function (_VerticalBarSeries) {
  ...
  function EuiVerticalBarSeries() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(EuiVerticalBarSeries)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(EuiVerticalBarSeries, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_reactVis.VerticalBarSeries, _extends({
        key: name,
        className: classes,
...
exports.EuiVerticalBarSeries = EuiVerticalBarSeries;
