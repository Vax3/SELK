...
var _legend_item = _interopRequireDefault(require("./legend_item"));
...
function MoreSeries(_ref7) {
  ...
  return _react.default.createElement(MoreSeriesContainer, null, "(+", hiddenSeries, ")");
}
...
function Legends(_ref8) {
  ...
  return _react.default.createElement("div", null, _react.default.createElement(Title, null, chartTitle), _react.default.createElement(Container, null, series.filter(function (serie) {
    return !serie.isEmpty;
  }).map(function (serie, i) {
    var text = _react.default.createElement(LegendContent, null, truncateLegends ? _react.default.createElement(TruncatedLabel, {
      title: serie.title
    }, serie.title) : serie.title, serie.legendValue && _react.default.createElement(SeriesValue, null, serie.legendValue));

    return _react.default.createElement(_legend_item.default, {
      key: i,
  ...
  }), _react.default.createElement(MoreSeries, {
