...
function (_AbstractSeries) {
  ...
  _createClass(EuiBarSeries, [{
    ...
    value: function render() {
      ...
      var BarSeriesComponent = _orientation === _chart_utils.ORIENTATION.HORIZONTAL ? _reactVis.HorizontalBarSeries : _reactVis.VerticalBarSeries;
      return _react.default.createElement(BarSeriesComponent, _extends({
        name: name,
        className: classes,
    ...
    value: function getParentConfig(attr, props) {
      ...
      return _orientation === _chart_utils.ORIENTATION.HORIZONTAL ? _reactVis.HorizontalBarSeries.getParentConfig(attr) : _reactVis.VerticalBarSeries.getParentConfig(attr);
    }
  }]);
...
exports.EuiBarSeries = EuiBarSeries;
