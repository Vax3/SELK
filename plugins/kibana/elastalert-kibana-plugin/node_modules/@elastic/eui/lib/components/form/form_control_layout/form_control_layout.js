...
exports.EuiFormControlLayout = exports.ICON_SIDES = void 0;
  ...
  _createClass(EuiFormControlLayout, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["children", "icon", "clear", "fullWidth", "isLoading", "compressed", "className", "prepend", "append"]);
...
EuiFormControlLayout.propTypes = {
  ...
  icon: _propTypes.default.oneOfType([_propTypes.default.string, _propTypes.default.shape({
    type: _propTypes.default.string,
    side: _propTypes.default.oneOf(ICON_SIDES),
