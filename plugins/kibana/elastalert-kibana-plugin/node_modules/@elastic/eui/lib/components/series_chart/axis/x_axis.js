...
function (_PureComponent) {
  ...
  function EuiXAxis() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(EuiXAxis).apply(this, arguments));
  }
  ...
  _createClass(EuiXAxis, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_reactVis.XAxis, _extends({
        title: title,
...
EuiXAxis.propTypes = {
  ...
  orientation: _propTypes.default.oneOf([ORIENTATION.TOP, ORIENTATION.BOTTOM]),
