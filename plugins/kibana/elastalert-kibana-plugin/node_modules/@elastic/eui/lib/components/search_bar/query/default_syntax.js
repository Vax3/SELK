...
function () {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      return AST.Group.must([head].concat(_toConsumableArray(tail)));
    },
        peg$c9 = "-",
        peg$c10 = peg$literalExpectation("-", false),
        peg$c11 = function peg$c11(value) {
      return AST.Term.mustNot(value);
    },
        peg$c12 = function peg$c12(value) {
      return AST.Term.must(value);
    },
        peg$c13 = function peg$c13(flag) {
      return AST.Is.mustNot(flag);
    },
        peg$c14 = function peg$c14(flag) {
      return AST.Is.must(flag);
    },
        peg$c15 = "is:",
        peg$c16 = peg$literalExpectation("is:", false),
        peg$c17 = function peg$c17(flag) {
      validateFlag(flag, location(), ctx);
      return flag;
    },
        peg$c18 = peg$otherExpectation("field"),
      ...
      return AST.Field.must.lte(fv.field, fv.value);
        ...
        peg$c33 = function peg$c33(field, valueExpression) {
      return {
        field: field,
        ...
        peg$c38 = function peg$c38(field, valueExpression) {
      return {
        field: field,
        value: resolveFieldValue(field, valueExpression, ctx)
      };
        ...
        peg$c45 = peg$otherExpectation("flag name"),
        peg$c46 = peg$otherExpectation("field name"),
        peg$c47 = function peg$c47() {
      return unescapeValue(text());
    },
        peg$c48 = /^[\-_]/,
        peg$c49 = peg$classExpectation(["-", "_"], false, false),
        peg$c50 = peg$otherExpectation("field value"),
        peg$c51 = peg$otherExpectation("term"),
        peg$c52 = function peg$c52(value) {
      return value.expression;
    },
        peg$c53 = function peg$c53(head, value) {
      return value;
    },
      ...
      return [head].concat(_toConsumableArray(tail));
        ...
        peg$c57 = function peg$c57(phrase) {
      ...
      return Exp.string(unescapeValue(text()), location());
        ...
        peg$c59 = /^[\-_*:\/]/,
        peg$c60 = peg$classExpectation(["-", "_", "*", ":", "/"], false, false),
        peg$c61 = /^[\xC0-\uFFFF]/,
        peg$c62 = peg$classExpectation([["\xC0", "\uFFFF"]], false, false),
        peg$c63 = "\\",
        peg$c64 = peg$literalExpectation("\\", false),
        peg$c65 = /^[\-:\\]/,
        peg$c66 = peg$classExpectation(["-", ":", "\\"], false, false),
        peg$c67 = /^[oO]/,
        peg$c68 = peg$classExpectation(["o", "O"], false, false),
        peg$c69 = /^[rR]/,
        peg$c70 = peg$classExpectation(["r", "R"], false, false),
        peg$c71 = function peg$c71(bool) {
      return bool;
    },
        peg$c72 = peg$anyExpectation(),
        peg$c73 = /^[tT]/,
        peg$c74 = peg$classExpectation(["t", "T"], false, false),
        peg$c75 = /^[uU]/,
        peg$c76 = peg$classExpectation(["u", "U"], false, false),
        peg$c77 = /^[eE]/,
      ...
      return Exp.boolean(text(), location());
        ...
        peg$c80 = /^[fF]/,
        peg$c81 = peg$classExpectation(["f", "F"], false, false),
        peg$c82 = /^[aA]/,
        peg$c83 = peg$classExpectation(["a", "A"], false, false),
        peg$c84 = /^[lL]/,
        peg$c85 = peg$classExpectation(["l", "L"], false, false),
        peg$c86 = /^[sS]/,
        peg$c87 = peg$classExpectation(["s", "S"], false, false),
        peg$c88 = /^[yY]/,
        peg$c89 = peg$classExpectation(["y", "Y"], false, false),
        peg$c90 = /^[nN]/,
        peg$c91 = peg$classExpectation(["n", "N"], false, false),
        peg$c92 = /^[\-]/,
      ...
      return text();
        ...
        peg$c103 = function peg$c103(expression) {
      return Exp.date(expression, location());
    },
        peg$c104 = peg$otherExpectation("alpha numeric"),
        peg$c105 = /^[a-zA-Z0-9.]/,
