...
function (_AbstractSeries) {
  ...
  function EuiCrosshairX() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_formatXValue", function (x) {
      ...
      if (xType === _chart_utils.SCALE.TIME || xType === _chart_utils.SCALE.TIME_UTC) {
        return xCrosshairFormat ? (0, _moment.default)(x).format(xCrosshairFormat) : new Date(x).toISOString();
      } else {
        return x;
      }
    });
  ...
  _createClass(EuiCrosshairX, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_reactVis.Crosshair, _extends({
        values: values,
        style: {
          line: {
...
exports.EuiCrosshairX = EuiCrosshairX;
