...
exports.EuiPopover = exports.ANCHOR_POSITIONS = void 0;
  ...
  _createClass(EuiPopover, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["anchorClassName", "anchorPosition", "button", "isOpen", "ownFocus", "withTitle", "children", "className", "closePopover", "panelClassName", "panelPaddingSize", "popoverRef", "hasArrow", "repositionOnScroll", "zIndex", "initialFocus"]);

      var classes = (0, _classnames.default)('euiPopover', anchorPositionToClassNameMap[anchorPosition], {
      ...
      if (!this.state.suppressingPopover && (isOpen || this.state.isClosing)) {
        ...
        panel = _react.default.createElement(_portal.EuiPortal, null, _react.default.createElement(_focus_trap.EuiFocusTrap, {
